    ...
    public class LojasController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Lojas != null ? 
                          ...
                          Problem("Entity set 'DBContext.Lojas'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Endereco,Telefone,Email")] Loja loja)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Endereco,Telefone,Email")] Loja loja)
        {
            if (id != loja.Id)
            {
                return NotFound();
